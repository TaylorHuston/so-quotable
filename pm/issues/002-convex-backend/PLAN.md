...
# Implementation Plan: 002 - Convex Backend Setup (Pragmatic MVP)
...
**Dependencies**:
- 001: Next.js project must be initialized (✅ completed)
...
- Formal tests added later in 005 (testing infrastructure)
...
### Future Testing
- 005 will add formal tests with convex-test
...
- **003**: Cloudinary integration will use cloudinaryId fields in images table
- **004**: Convex Auth will add user relationships to all tables
- **005**: Testing infrastructure will add formal convex-test suite
