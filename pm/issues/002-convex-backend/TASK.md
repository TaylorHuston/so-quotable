...
# 002: Set up Convex backend and database schema
...
- 001: Next.js project must be initialized
...
- Create health.ts with ping query for health check endpoint (from 001):
